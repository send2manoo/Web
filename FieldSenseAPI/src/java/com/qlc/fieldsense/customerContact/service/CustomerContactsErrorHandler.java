 ...
 */
@ControllerAdvice
public class CustomerContactsErrorHandler {

    /**
     *
     */
    public static final Logger log4jLog = Logger.getLogger("CustomerContactsErrorHandler");
     ...
     */
    @Autowired
    public CustomerContactsErrorHandler(MessageSource messageSource) {
