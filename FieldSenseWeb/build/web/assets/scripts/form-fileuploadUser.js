    ...
    return {
        ...
        init: function () {
            ...
            $('#fileupload').fileupload({
                ...
                url: fieldSenseURL + '/user/importUser'
            });
            ...
            $('#fileupload').fileupload({
                ...
                success: function (data) {
                    if (data.errorCode == 0000) {
                        if (data.errorMessage == 'Users created successfully .') {
                            $('#id_errorFile').html('');
				...
				if(data.resultType.indexOf("No Error File")==0){
					$('#id_errorFile').html('');
		                        ...
		                        $('#id_errorFile').html(template);
		                        fieldSenseTosterErrorNoTimeOut(data.errorMessage, true); // edited by vaibhav
                                }
                            } else {
                                $('#id_errorFile').html('');
                                var template = '';
