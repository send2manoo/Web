 ...
 * @author anuja
 * @date 30-1-2014
 * @purpose To handle Customer errors
 */
@ControllerAdvice
public class CustomerErrorHandler {
     ...
     *
     */
    public static final Logger log4jLog = Logger.getLogger("CustomerErrorHandler");
     ...
     */
    @Autowired
    public CustomerErrorHandler(MessageSource messageSource) {
