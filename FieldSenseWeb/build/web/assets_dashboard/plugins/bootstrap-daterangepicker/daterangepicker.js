        ...
        updateCalendars: function () {
            ...
            for (var range in this.ranges) {
                if (this.timePicker) {
                    ...
                    if (this.startDate.format('DD MMM YY') == this.ranges[range][0].format('DD MMM YY') && this.endDate.format('DD MMM YY') == this.ranges[range][1].format('DD MMM YY')) {
                        customRange = false;
                        this.container.find('.ranges li:eq(' + i + ')').addClass('active');
                    }
                }
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    if ((minDate && calendar[row][col].isBefore(minDate)) || (maxDate && calendar[row][col].isAfter(maxDate))) {
                        cname = ' off disabled ';
                    } else if (calendar[row][col].format('DD MMM YY') == selected.format('DD MMM YY')) {
                        cname += ' active ';
                        if (calendar[row][col].format('DD MMM YY') == this.startDate.format('DD MMM YY')) {
                            cname += ' start-date ';
                        }
                        if (calendar[row][col].format('DD MMM YY') == this.endDate.format('DD MMM YY')) {
                            cname += ' end-date ';
                        }
