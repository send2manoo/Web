...
(function ($) {
    ...
    Date.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        ...
        **/
        ...
        @default 'x clear'
        **/
        clear: 'clear <i class="fa fa-times" style="font-size:12px"></i>'
    });
...
(function ($) {
    ...
    DateField.defaults = $.extend({}, $.fn.editabletypes.date.defaults, {
        ...
        @property tpl 
        **/         
        tpl:'<div class="input-group input-group-fixed date"><input type="text" readonly class="form-control  pull-left"/><span class="input-group-btn pull-left"><button class="btn default" type="button"><i class="fa fa-calendar"></i></button></span></div>',
        /**
        @property inputclass 
        @default 'input-small'
        **/         
...
(function ($) {
    ...
    DateTimeField.defaults = $.extend({}, $.fn.editabletypes.datetime.defaults, {
        ...
        @property tpl 
        **/    
        tpl:'<div class="input-group input-group-fixed date"><input type="text" readonly class="form-control  pull-left"/><span class="input-group-btn pull-left"><button class="btn date-set default" type="button"><i class="fa fa-calendar"></i></button></span></div>',
         /**
        @property inputclass 
        @default 'input-medium'
        **/         
