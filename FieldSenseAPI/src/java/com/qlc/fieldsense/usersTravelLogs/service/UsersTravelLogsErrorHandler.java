 ...
 */
@ControllerAdvice
public class UsersTravelLogsErrorHandler {

    /**
     *
     */
    public static final Logger log4jLog = Logger.getLogger("UsersTravelLogsErrorHandler");
     ...
     */
    @Autowired
    public UsersTravelLogsErrorHandler(MessageSource messageSource) {
