	...
	$.extend(F, {
		...
		defaults: {
			...
			tpl: {
				...
				image    : '<img class="fancybox-image" src="http://fieldsense.in/wp-content/uploads/{href}" alt="" />',
		...
		_afterLoad: function () {
			...
			switch (type) {
				...
				case 'swf':
					...
					content += '<embed src="http://fieldsense.in/wp-content/uploads/' + href + '" type="application/x-shockwave-flash" width="100%" height="100%"' + embed + '></embed></object>';
				break;
			}
