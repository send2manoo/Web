...
@ControllerAdvice
public class CustomerOfflineErrorHandler {
    
    /**
     *
     */
    public static final Logger log4jLog = Logger.getLogger("CustomerOfflineErrorHandler");
     ...
     */
    @Autowired
    public CustomerOfflineErrorHandler(MessageSource messageSource) {
