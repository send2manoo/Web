...
*
* @Improved by KeenThemes for Conquer Bootstrap 3.0
        ...
        updateCalendars: function () {
            ...
            for (var range in this.ranges) {
                if (this.timePicker) {
                    ...
                    if (this.startDate.format('D MMM YYYY') == this.ranges[range][0].format('D MMM YYYY') && this.endDate.format('D MMM YYYY') == this.ranges[range][1].format('D MMM YYYY')) {
                        customRange = false;
                        this.container.find('.ranges li:eq(' + i + ')').addClass('active');
                    }
                }
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    if ((minDate && calendar[row][col].isBefore(minDate)) || (maxDate && calendar[row][col].isAfter(maxDate))) {
                        cname = ' off disabled ';
                    } else if (calendar[row][col].format('D MMM YYYY') == selected.format('D MMM YYYY')) {
                        cname += ' active ';
                        if (calendar[row][col].format('D MMM YYYY') == this.startDate.format('D MMM YYYY')) {
                            cname += ' start-date ';
                        }
                        if (calendar[row][col].format('D MMM YYYY') == this.endDate.format('D MMM YYYY')) {
                            cname += ' end-date ';
                        }
