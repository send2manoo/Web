var FormEditable = function () {
    ...
    var initEditables = function () {
        ...
        $.each({
            ...
            "VA": "Holy See (Vatican date State)",
        ...
        $('#address, #address2, #address3, #address4').editable({
            url: '/post',
            value: {
                date: "30 Jan 2016",
                reason: ""
            ...
            validate: function (value) {
                if (value.reason == '') return 'Date and Reason is required!';
            },
            display: function (value) {
                ...
                var html = '<b>' + $('<div>').text(value.date).html()/* + '</b> ' + $('<div>').text(value.reason).html()*/;
                $(this).html(html);
            }
        });
