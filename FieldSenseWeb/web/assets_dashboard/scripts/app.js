...
var App = function () {
    ...
    var handleScrollersForMyTeam = function () {
        $('.scrollerMyTeam').each(function () {
            var height;
            if ($(this).attr("data-height")) {
                height = $(this).attr("data-height");
            } else {
        ...
        var handleScrollersForLeaderboard = function () {
        $('.scrollerLeaderboard').each(function () {
            var height;
            if ($(this).attr("data-height")) {
                height = $(this).attr("data-height");
            } else {
    ...
    return {
        ...
        init: function () {
            ...
            handleScrollersForMyTeam();// handles slim scrolling contents 
            handleScrollersForLeaderboard();
