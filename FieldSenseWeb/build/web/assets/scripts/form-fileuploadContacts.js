    ...
    return {
        ...
        init: function() {
            ...
            $('#fileupload').fileupload({
                ...
                url: fieldSenseURL + '/customerContact/importCustomerContacts'
            });
            ...
            $('#fileupload').fileupload({
                ...
                success: function(data) {
                    if (data.errorCode == 0000) {
                        if (data.errorMessage == 'Customer contact created successfully') {
                            $('#id_errorFile').html('');
                           ...
                           /* var errorFileURL = data.result;
                            ...
                            fieldSenseTosterSuccessNoTimeOut(data.errorMessage, true);*/
                            if(data.result.indexOf("ContactImportError")==0){
					$('#id_errorFile').html('');
		                        var template = '';
		                        template += '<div class="alert alert-danger">';
