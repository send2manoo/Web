var FormComponents = function () {
    ...
    var handleSelect2 = function () {
        ...
        function format(state) {
            ...
            return "<img class='flag' src='assets/img/" + state.id.toLowerCase() + ".png'/>&nbsp;&nbsp;" + state.text;
        }
        ...
        $("#select2_sample5").select2({
            tags: ["Member1", "Member2", "Member3", "Member4", "Member5"]
        });
    ...
    var handleSelect2Modal = function () {
        ...
        $("#select2_sample_modal_5").select2({
            tags: ["Member1", "Member2", "Member3", "Member4", "Member5", "Member6", "Member7", "Member8", "Member9", "Member10"]
        });
    ...
    var handleInputMasks = function () {
        ...
        $("#mask_phone1").inputmask("mask", {
            "mask": "999-99999999"
        });
        $("#mask_phone2").inputmask("mask", {
            "mask": "999-99999999"
        });
        $("#mask_phone3").inputmask("mask", {
            "mask": "999-99999999"
        });		
        $("#mask_fax").inputmask("mask", {
            "mask": "999-99999999"
        });	
        $("#mask_fax2").inputmask("mask", {
            "mask": "999-99999999"
        });			
        $("#mask_mobile").inputmask("mask", {
            "mask": "99-9999999999"
        });
        $("#mask_mobile1").inputmask("mask", {
            "mask": "99-9999999999"
        });	
        $("#mask_mobile3").inputmask("mask", {
            "mask": "99-9999999999"
        });
        $("#mask_mobile4").inputmask("mask", {
            "mask": "99-9999999999"
