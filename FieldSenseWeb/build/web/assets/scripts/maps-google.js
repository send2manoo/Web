var MapsGoogle = function () {
    ...
    var mapMarker = function () {
        ...
        map.addMarker({
            ...
            infoWindow: {
                content: '<div class="info_hold"><div class="gm-title"><h4>Saurabh Karandikar</h4></div><div class="gm-basicinfo"><h5>In Transit</h5></div></div>'
            }
        });		
        map.addMarker({
            lat: 19.118391,
            ...
            title: 'Marker with InfoWindow',
            infoWindow: {
                content: '<div class="info_hold"><div class="gm-title"><h4>Mangesh lad</h4></div><div class="gm-basicinfo"><h5>In Transit</h5></div></div>'
            }
        });
        map.addMarker({
            lat: 19.113621,
            ...
            title: 'Marker with InfoWindow',
            infoWindow: {
                content: '<div class="info_hold"><div class="gm-title"><h4>Sharad Popli</h4></div><div class="gm-basicinfo"><h5>In Transit</h5></div></div>'
            }
        });
    }
